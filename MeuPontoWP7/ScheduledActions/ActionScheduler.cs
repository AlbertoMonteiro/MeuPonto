            ...
            _lembretes.Add(new Lembrete
                {
                    ...
                    Mensagem =
                        string.Format(
                            "Aproximadamente 5 minutos para atingir jornada máxima.\nJornada máxima completa as {0:HH:mm:ss}.",
                            horarioJornadaMaxima),
            ...
            _lembretes.Add(new Lembrete
                {
                    ...
                    Mensagem =
                        string.Format(
                            "Aproximadamente 5 minutos para atingir tempo de pausa.\nTempo de pausa completa as {0:HH:mm:ss}.",
                            horarioFimTempoIntervalo),
            ...
            _lembretes.Add(new Lembrete
                {
                    ...
                    Mensagem =
                        string.Format(
                            "Aproximadamente 5 minutos para turno máximo.\nTurno maximo expira as {0:HH:mm:ss}.",
                            horarioTurnoMaximo),
